...
import static com.appiancorp.recordlevelsecurity.ReadOnlyRecordUiSecurity.RECORD_TYPE_UI_SECURITY_TABLE_NAME;
...
@Hidden
@Entity
@Table(name = RECORD_TYPE_UI_SECURITY_TABLE_NAME)
@IgnoreJpa
@XmlRootElement(namespace = com.appiancorp.suiteapi.type.Type.APPIAN_NAMESPACE, name="recordTypeRelatedActionSecurityCfg")
@XmlType(namespace = com.appiancorp.suiteapi.type.Type.APPIAN_NAMESPACE, name= RecordTypeRelatedActionSecurityCfg.LOCAL_PART,
...
public class RecordTypeRelatedActionSecurityCfg implements Id<Long>, ReadOnlyRecordUiSecurity {
  ...
  public RecordTypeRelatedActionSecurityCfg(DesignerDtoRecordRowLevelSecurityCfg dto) {
    this.id = dto.getId();
  ...
  public final boolean equals(Object o) {
    ...
    if (!(o instanceof RecordTypeRelatedActionSecurityCfg)) {
      return false;
    }

    RecordTypeRelatedActionSecurityCfg that = (RecordTypeRelatedActionSecurityCfg)o;
