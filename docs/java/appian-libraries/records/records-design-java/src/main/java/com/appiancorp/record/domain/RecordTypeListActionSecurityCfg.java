...
@IgnoreJpa
@XmlRootElement(namespace = com.appiancorp.suiteapi.type.Type.APPIAN_NAMESPACE, name="recordTypeListActionSecurityCfg")
@XmlType(namespace = com.appiancorp.suiteapi.type.Type.APPIAN_NAMESPACE, name= RecordTypeListActionSecurityCfg.LOCAL_PART,
    propOrder={PROP_ID, PROP_MEMBERSHIP_FILTER, PROP_DATA_FILTER})
public class RecordTypeListActionSecurityCfg implements Id<Long>, ReadOnlyRecordUiSecurity {
  public static final String LOCAL_PART = "RecordTypeListActionSecurityCfg";

  private Long id;
  private String dataFilter;
  private String membershipFilter;

  public RecordTypeListActionSecurityCfg() {}

  public RecordTypeListActionSecurityCfg(DesignerDtoRecordRowLevelSecurityCfg dto) {
    this.id = dto.getId();
  ...
  public final boolean equals(Object o) {
    ...
    if (!(o instanceof RecordTypeListActionSecurityCfg)) {
      return false;
    }

    RecordTypeListActionSecurityCfg that = (RecordTypeListActionSecurityCfg)o;
