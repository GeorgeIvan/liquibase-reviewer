...
@Entity
@Table(
    name = "persona_design_object_ref",
    uniqueConstraints = @UniqueConstraint(columnNames = {"design_object_uuid", "req_capture_persona_id"})
)
public class PersonaDesignObjectRef implements Serializable {
  ...
  public PersonaDesignObjectRef designObjectUuid(String designObjectUuid) {
    this.designObjectUuid = designObjectUuid;
    return this;
  }
  ...
  public PersonaDesignObjectRef designObjectQName(String designObjectQName) {
    this.designObjectQName = designObjectQName;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PersonaDesignObjectRef that = (PersonaDesignObjectRef) o;
    return Objects.equals(designObjectUuid, that.designObjectUuid) && Objects.equals(designObjectQName, that.designObjectQName);
  }
  ...
  public String toString() {
    return "Persona{" +
        "id=" + id +
        ", designObjectUuid=" + designObjectUuid +
